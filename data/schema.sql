...
INSERT INTO clientes(nombre, ape_pat, ape_mat, telefono, correo) VALUES
  ('Marco','Gutierrez','Morales','7757942706','magm@email.com'),
  ('Jorge','Morales','Paredes','7710235907','JoMa@email.com'),
  ('Karla','Gutierrez','Perez','7751475977','karla_gp@email.com');
...
CREATE USER 'manl'@'localhost' IDENTIFIED BY 'manl.2019';
GRANT ALL PRIVILEGES ON ferreteria.* TO 'manl'@'localhost';
FLUSH PRIVILEGES;
